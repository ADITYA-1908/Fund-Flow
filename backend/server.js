...
// import proxyRoutes from "./routes/proxyRoutes.js"; // ✅ Added
// dotenv.config();
...
// app.use("/api/proxy", proxyRoutes); // ✅ Your proxy route mounted
...
import swaggerRoutes from "./routes/swagger.js"; // ✅ Swagger UI route
